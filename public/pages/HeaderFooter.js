    ...
    const headerHTML = `
        <header class="relative z-20">
            ...
            <nav class="bg-white shadow-md">
                ...
                <div id="mobile-menu" class="xl:hidden fixed inset-0  sm:left-[50%] bg-white z-40 transform translate-x-full transition-transform duration-300 ease-in-out overflow-y-auto">
                    <div class="pt-4 pb-2">
                        <div class="flex justify-end px-4 mb-4">
                        
                            <button id="close-menu" aria-label="Close menu" class="focus:outline-none bg-[#246788] rounded focus:ring-2 focus:ring-blue-500">
                                <svg class="w-8 h-8 text-[#246788]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" class="text-white" />
                                </svg>
                            </button>
                        </div>
